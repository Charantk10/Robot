...
public class CommandLineUtil {
	...
	public static Integer selectMeasureByRoomType(Scanner sn, RoomType roomType) {		
	...
	public static Integer selectXCoordinate(Scanner sn) {
		System.out.println("Please Enter a starting x coordinate");
		return sn.nextInt();
	}
	
	public static Integer selectYCoordinate(Scanner sn) {
